...
int main()
{
	...
	if (letter == 'c' || letter == 'C')
	{
		...
		if (region == 3)
		{
			std::cout << "Cameroon, Cape Verde, Central African Republic, Comoros, Democratic Republic of the Congo, Congo Republic of (Brazzaville), Côte D'ivoire (Ivory Coast)" << std::endl;
		}
		if (region == 4)
		{
